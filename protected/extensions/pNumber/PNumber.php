...
class PNumber
{
	...
	public function number($num)
	{
        ...
        return str_replace($english_array, $farsi_array, $num);
	}
	
	/**
	 * http://blog.rastasoft.ir/fa
	 */
	public function numberToWords($number)
	{	
		$number = str_replace(',', '', $number);
		$formated = $this->numberFormat($number, 0, '.', ',');
	...
	private function numberFormat($number, $decimal_precision = 0, $decimals_separator = '.', $thousands_separator = ',')
	{
	...
	private function groupToWords($group) {
		$d3 = floor($group / 100);
